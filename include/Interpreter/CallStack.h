...
class CallContext {
 ...
 private:
  ...
  std::optional<std::reference_wrapper<const FunctionDefNode>> function_sig_;
 ...
 public:
  ...
  std::optional<std::reference_wrapper<const FunctionDefNode>> getFunctionSig() const noexcept;
};
